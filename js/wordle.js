...
function gridSetup() {
    for (const child of word0.children) {
        setStatus(child, 'inactive')
    }
    for (const child of word1.children) {
        setStatus(child, 'inactive')
    }
    for (const child of word2.children) {
        setStatus(child, 'inactive')
    }
    for (const child of word3.children) {
        setStatus(child, 'inactive')
    }
    for (const child of word4.children) {
        setStatus(child, 'inactive')
    }
